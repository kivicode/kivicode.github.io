...
Calling the `Doc` varructor without `new` works again.
...
*   Make documents a [first-class varruct](http://codemirror.net/doc/manual.html#api_doc), support split views and subviews.
